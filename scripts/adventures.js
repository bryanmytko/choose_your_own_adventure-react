module.exports = [
...

  {
    ...
    "text": "You approach a bridge in the gloomy woods. As the wind blows through the trees, you can hear the boards creak as the bridge gently sways. It's impossible to see what is below or how far across the bridge stretches...",
    "options": [
      { "label": "Try to cross the bridge", "to": 2 },
